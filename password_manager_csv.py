"""
PASSWORD MANAGER PROJECT (CSV FILE VERSION)
Class 12 CBSE - Computer Science
Uses csv module to store records in a comma-separated (.csv) file.
...
def copy_file():
    ...
    backup_name = input("Enter name for backup file (e.g. backup.csv): ")

    with open(backup_name, "w", newline="") as f2:
